...
const InputSection = () => {
    ...
    return (
      <div >
        <h3 className='mb-4'>Recebidos</h3>
        <Card>
          <div className='d-flex flex-column p-5 bg-info'>
            ...
            <Button label="Realizar Lançamento" className='mt-5' onClick={realizarLancamento}>Atualizar</Button>
          </div>
